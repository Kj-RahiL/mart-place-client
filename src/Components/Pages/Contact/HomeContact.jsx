...
// console.log(form.current)
    ...
    return (
        <div className="bg-cover bg-pink-50" style={{ backgroundImage: `url(${bg})`}}>
            <h3 className="bg-white text-center py-10 text-5xl text-pink-700 font-semibold">Message Us</h3>
